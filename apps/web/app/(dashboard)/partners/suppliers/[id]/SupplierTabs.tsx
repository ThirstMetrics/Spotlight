...
interface DistributorPartnerRow {
...
interface SupplierTabsProps {
  distributorPartners: DistributorPartnerRow[];
...
// === Distributor Partners Table (NEW — unique to supplier view) ===

function DistributorPartnersTable({ data }: { data: DistributorPartnerRow[] }) {
    ...
    <Card className="border-l-4 border-l-[#06113e]">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-lg">Distributor Partners</CardTitle>
        </div>
        <CardDescription>
          Which distributors carry this supplier&apos;s products and volume flowing through each
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-gray-50/50">
                ...
                <th className="px-3 py-2.5 text-right font-medium text-gray-600">Products Carried</th>
...
export function SupplierTabs({ distributorPartners, outletPerformance, productPerformance, winePortfolio }: SupplierTabsProps) {
  return (
    <div className="space-y-6">
      <DistributorPartnersTable data={distributorPartners} />
